...
//           {identifiedPokemon && (
//             <Text style={styles.resultText}>Identified Pokémon: {identifiedPokemon.name}</Text>
//           )}
//         </View>
//       </View>
//     </Modal>
...
//             <View>
//               <Text style={styles.resultText}>Identified Pokémon:</Text>
//               {identifiedPokemon.map((pokemon, index) => (
//                 <Text key={index} style={styles.resultText}>{pokemon.name}</Text>
//               ))}
//             </View>
//           )}
//         </View>
